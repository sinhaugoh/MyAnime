...
import TopRankedView from "../TopRankedView";
...
describe("<TopRankedView />", () => {
  ...
  it("should match snapshot", async () => {
    JikanApi.fetchTopRankedAnime.mockResolvedValue(fixture);
    render(<TopRankedView />);
    await waitFor(() => {
  ...
  it("should call fetchAiringAnime once on render", async () => {
    ...
    await act(async () => {
      expect(JikanApi.fetchTopRankedAnime).toHaveBeenCalledTimes(1);
    });
  });
